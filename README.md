...
| 5.5    | :x:                | :x:                | :x:                | :x:                | :x:                | :x:                | :x:                | :x:                | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
```bash
$ composer require "graham-campbell/gitlab:^5.5" "guzzlehttp/guzzle:^7.2" "http-interop/http-factory-guzzle:^1.0"
```
